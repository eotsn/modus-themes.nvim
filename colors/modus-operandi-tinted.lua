...
vim.api.nvim_set_hl(0, "CursorLineFold", {bg = "#efe9dd", fg = "#005e8b"})
...
vim.api.nvim_set_hl(0, "FoldColumn", {bg = "#efe9dd", fg = "#005e8b"})
vim.api.nvim_set_hl(0, "Folded", {bg = "#dfd5cf", fg = "#595959"})
...
vim.api.nvim_set_hl(0, "PmenuSel", {bg = "#f0c1cf", bold = true})
...
vim.api.nvim_set_hl(0, "WinSeparator", {bg = "#efe9dd", fg = "#9f9690"})
...
vim.api.nvim_set_hl(0, "DiagnosticSignError", {bg = "#efe9dd", fg = "#a60000"})
vim.api.nvim_set_hl(0, "DiagnosticSignHint", {bg = "#efe9dd", fg = "#005f5f"})
vim.api.nvim_set_hl(0, "DiagnosticSignInfo", {bg = "#efe9dd", fg = "#005f5f"})
vim.api.nvim_set_hl(0, "DiagnosticSignWarn", {bg = "#efe9dd", fg = "#884900"})
...
vim.api.nvim_set_hl(0, "BlinkCmpMenu", {bg = "#efe9dd", fg = "#000000"})
vim.api.nvim_set_hl(0, "BlinkCmpMenuBorder", {bg = "#efe9dd", fg = "#c9b9b0"})
...
vim.api.nvim_set_hl(0, "BlinkCmpDoc", {bg = "#efe9dd", fg = "#000000"})
vim.api.nvim_set_hl(0, "BlinkCmpDocBorder", {bg = "#efe9dd", fg = "#9f9690"})
vim.api.nvim_set_hl(0, "BlinkCmpDocSeparator", {bg = "#efe9dd", fg = "#9f9690"})
vim.api.nvim_set_hl(0, "BlinkCmpDocCursorLine", {bg = "#f1d5d0"})
vim.api.nvim_set_hl(0, "BlinkCmpSignatureHelp", {bg = "#efe9dd", fg = "#000000"})
vim.api.nvim_set_hl(0, "BlinkCmpSignatureHelpBorder", {bg = "#efe9dd", fg = "#9f9690"})
...
vim.api.nvim_set_hl(0, "SnacksPickerBorder", {bg = "#fbf7f0", fg = "#595959"})
...
vim.api.nvim_set_hl(0, "SnacksPickerTitle", {bg = "#fbf7f0", fg = "#595959"})
...
vim.api.nvim_set_hl(0, "MiniDiffSignChange", {bg = "#c0b200", fg = "#553d00"})
vim.api.nvim_set_hl(0, "MiniDiffSignDelete", {bg = "#d84a4f", fg = "#8f1313"})
vim.api.nvim_set_hl(0, "MiniIndentscopeSymbol", {fg = "#c9b9b0"})
...
vim.api.nvim_set_hl(0, "MiniSnippetsFinal", {sp = "#fbf7f0"})
vim.api.nvim_set_hl(0, "MiniSnippetsUnvisited", {sp = "#fbf7f0"})
vim.api.nvim_set_hl(0, "MiniSnippetsVisited", {sp = "#fbf7f0"})
