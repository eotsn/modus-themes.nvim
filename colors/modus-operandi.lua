...
vim.api.nvim_set_hl(0, "unspecified", {bg = "#000000", fg = "#ffffff"})
...
vim.api.nvim_set_hl(0, "CursorLine", {bg = "#dae5ec"})
...
vim.api.nvim_set_hl(0, "PmenuSel", {bg = "#c0deff"})
...
vim.api.nvim_set_hl(0, "WinSeparator", {fg = "#c4c4c4"})
...
vim.api.nvim_set_hl(0, "BlinkCmpMenu", {bg = "#f2f2f2"})
vim.api.nvim_set_hl(0, "BlinkCmpMenuBorder", {fg = "#c4c4c4"})
...
vim.api.nvim_set_hl(0, "SnacksPickerBorder", {bg = "#ffffff", fg = "#9f9f9f"})
